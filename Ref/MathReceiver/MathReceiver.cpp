...
namespace Ref {
    ...
    )
  {
    ...
    // Handle error case and success case
    if (err != MathErr::NoErr) {
        this->mathOpReject_out(0, err, val1, op, val2);
    } else {
